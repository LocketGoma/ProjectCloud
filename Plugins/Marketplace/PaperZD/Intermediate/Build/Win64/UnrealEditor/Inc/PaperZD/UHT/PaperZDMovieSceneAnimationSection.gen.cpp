...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDMovieSceneAnimationParams>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDMovieSceneAnimationParams::StaticStruct, Z_Construct_UScriptStruct_FPaperZDMovieSceneAnimationParams_Statics::NewStructOps, TEXT("PaperZDMovieSceneAnimationParams"), &Z_Registration_Info_UScriptStruct_PaperZDMovieSceneAnimationParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDMovieSceneAnimationParams), 3385571399U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDMovieSceneAnimationSection, UPaperZDMovieSceneAnimationSection::StaticClass, TEXT("UPaperZDMovieSceneAnimationSection"), &Z_Registration_Info_UClass_UPaperZDMovieSceneAnimationSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDMovieSceneAnimationSection), 2720303967U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_3641651242(TEXT("/Script/PaperZD"),
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationSection_h_Statics::ScriptStructInfo),
		nullptr, 0);
