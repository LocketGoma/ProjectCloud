...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimNode_SelectByEnum>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SelectByEnum_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SelectByEnum_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimNode_SelectByEnum::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_SelectByEnum_Statics::NewStructOps, TEXT("PaperZDAnimNode_SelectByEnum"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_SelectByEnum, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_SelectByEnum), 3103080271U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SelectByEnum_h_3262508780(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SelectByEnum_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SelectByEnum_h_Statics::ScriptStructInfo),
		nullptr, 0);
