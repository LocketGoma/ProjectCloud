...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimNode_UseCachedAnimation>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_UseCachedAnimation_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_UseCachedAnimation_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimNode_UseCachedAnimation::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_UseCachedAnimation_Statics::NewStructOps, TEXT("PaperZDAnimNode_UseCachedAnimation"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_UseCachedAnimation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_UseCachedAnimation), 3650219374U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_UseCachedAnimation_h_578527492(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_UseCachedAnimation_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_UseCachedAnimation_h_Statics::ScriptStructInfo),
		nullptr, 0);
