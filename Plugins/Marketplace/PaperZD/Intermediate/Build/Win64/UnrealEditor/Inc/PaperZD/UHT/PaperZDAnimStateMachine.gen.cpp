...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimStateMachine>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimStateMachine_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimStateMachine_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimStateMachineTransitionRule::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimStateMachineTransitionRule_Statics::NewStructOps, TEXT("PaperZDAnimStateMachineTransitionRule"), &Z_Registration_Info_UScriptStruct_PaperZDAnimStateMachineTransitionRule, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimStateMachineTransitionRule), 1443484475U) },
		...
		{ FPaperZDAnimStateMachineNode::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimStateMachineNode_Statics::NewStructOps, TEXT("PaperZDAnimStateMachineNode"), &Z_Registration_Info_UScriptStruct_PaperZDAnimStateMachineNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimStateMachineNode), 207200443U) },
		{ FPaperZDAnimStateMachine::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimStateMachine_Statics::NewStructOps, TEXT("PaperZDAnimStateMachine"), &Z_Registration_Info_UScriptStruct_PaperZDAnimStateMachine, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimStateMachine), 3389237107U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimStateMachine_h_435400987(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimStateMachine_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimStateMachine_h_Statics::ScriptStructInfo),
		nullptr, 0);
