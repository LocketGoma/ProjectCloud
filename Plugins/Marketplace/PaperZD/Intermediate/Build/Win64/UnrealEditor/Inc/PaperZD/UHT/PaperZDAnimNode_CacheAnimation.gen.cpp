...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimNode_CacheAnimation>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_CacheAnimation_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_CacheAnimation_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimNode_CacheAnimation::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_CacheAnimation_Statics::NewStructOps, TEXT("PaperZDAnimNode_CacheAnimation"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_CacheAnimation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_CacheAnimation), 1189548196U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_CacheAnimation_h_3139864039(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_CacheAnimation_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_CacheAnimation_h_Statics::ScriptStructInfo),
		nullptr, 0);
