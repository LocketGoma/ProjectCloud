...
void FPaperZDPlaySlotOverrideOutputSignature_DelegateWrapper(const FMulticastScriptDelegate& PaperZDPlaySlotOverrideOutputSignature)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPaperZDPlaySlotOverrideAction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPaperZDPlaySlotOverrideAction_OnAnimationOverrideEnd, "OnAnimationOverrideEnd" }, // 3785832601
		{ &Z_Construct_UFunction_UPaperZDPlaySlotOverrideAction_PlayAnimationOverrideWithCallbacks, "PlayAnimationOverrideWithCallbacks" }, // 2751482452
	};
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDPlaySlotOverrideAction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDPlaySlotOverrideAction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperZDPlaySlotOverrideAction, UPaperZDPlaySlotOverrideAction::StaticClass, TEXT("UPaperZDPlaySlotOverrideAction"), &Z_Registration_Info_UClass_UPaperZDPlaySlotOverrideAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperZDPlaySlotOverrideAction), 73639139U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDPlaySlotOverrideAction_h_3811445169(TEXT("/Script/PaperZD"),
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDPlaySlotOverrideAction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDPlaySlotOverrideAction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
