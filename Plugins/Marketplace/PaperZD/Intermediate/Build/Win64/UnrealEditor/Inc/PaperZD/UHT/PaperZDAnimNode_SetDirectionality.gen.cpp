...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDAnimNode_SetDirectionality>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SetDirectionality_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SetDirectionality_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDAnimNode_SetDirectionality::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_SetDirectionality_Statics::NewStructOps, TEXT("PaperZDAnimNode_SetDirectionality"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_SetDirectionality, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_SetDirectionality), 4286289771U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SetDirectionality_h_79968631(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SetDirectionality_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_SetDirectionality_h_Statics::ScriptStructInfo),
		nullptr, 0);
