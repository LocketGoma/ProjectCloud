...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDMovieSceneAnimationTemplate>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationTemplate_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationTemplate_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDMovieSceneAnimationSectionTemplateParams::StaticStruct, Z_Construct_UScriptStruct_FPaperZDMovieSceneAnimationSectionTemplateParams_Statics::NewStructOps, TEXT("PaperZDMovieSceneAnimationSectionTemplateParams"), &Z_Registration_Info_UScriptStruct_PaperZDMovieSceneAnimationSectionTemplateParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDMovieSceneAnimationSectionTemplateParams), 3561373583U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationTemplate_h_3562073012(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationTemplate_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_Sequencer_PaperZDMovieSceneAnimationTemplate_h_Statics::ScriptStructInfo),
		nullptr, 0);
