...
template<> PAPERZD_API UScriptStruct* StaticStruct<FPaperZDSoftComponentReference>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDComponentReference_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDComponentReference_h_Statics::ScriptStructInfo[] = {
		{ FPaperZDComponentReference::StaticStruct, Z_Construct_UScriptStruct_FPaperZDComponentReference_Statics::NewStructOps, TEXT("PaperZDComponentReference"), &Z_Registration_Info_UScriptStruct_PaperZDComponentReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDComponentReference), 2905931635U) },
		{ FPaperZDSoftComponentReference::StaticStruct, Z_Construct_UScriptStruct_FPaperZDSoftComponentReference_Statics::NewStructOps, TEXT("PaperZDSoftComponentReference"), &Z_Registration_Info_UScriptStruct_PaperZDSoftComponentReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDSoftComponentReference), 483250064U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDComponentReference_h_1033770819(TEXT("/Script/PaperZD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDComponentReference_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_ProjectCloud_Plugins_Marketplace_PaperZD_Source_PaperZD_Public_PaperZDComponentReference_h_Statics::ScriptStructInfo),
		nullptr, 0);
